              ...
              <div class="card-body table-responsive p-0">
                  ...
                  <div class="row">
                      <div class="col-10 px-5">
                          <h1 class="mt-1">Form Data Portofolio</h1>
                          @if (session('status'))
                      ...
                      <form method="post" action="/portofolio">
                          @csrf
                          <div class="form-group">
                              <label for="tahun">Tahun :</label>
                              <input type="text" value="{{ old('tahun')}}" class="form-control @error('tahun') is-invalid @enderror" id="tahun" placeholder="Masukkan Tahun" name="tahun">
                              @error('tahun')<div class="alert alert-danger">The field is required</div>@enderror
                          </div>
                          <div class="form-group">
                              <label for="nama">Nama Portofolio :</label>
                              <input type="text" value="{{ old('nama')}}" class="form-control @error('nama') is-invalid @enderror" id="nama" placeholder="Masukkan Nama Portofolio" name="nama">
