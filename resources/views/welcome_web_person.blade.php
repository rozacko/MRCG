...
<link href="{{ asset('/web_person/css/bootstrap.css')}}" rel='stylesheet' type='text/css' />
<!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
<script src="{{ asset('/web_person/js/jquery.min.js')}}"></script>
<!-- Custom Theme files -->
<link href="{{ asset('/web_person/css/style.css')}}" rel='stylesheet' type='text/css' />
 <!-- Custom Theme files -->
...
<script type="{{ asset('/web_person/text/javascript')}}" src="js/move-top.js"></script>
<script type="{{ asset('/web_person/text/javascript')}}" src="js/easing.js"></script>
	<script type="{{ asset('/web_person/text/javascript')}}">
		...
		<!-- container -->
			...
			<div id="home" class="header">
				...
				<div class="top-header">
					...
					<div class="logo">
						<h1><a href="/"><span>Z</span> ROZACKO</a></h1>
					</div>
				...
				<div class="col-md-7 header-right">
					...
					<li>
						...
						<li>
							<ul class="address-text">
								<li><b>PHONE </b></li>
								<li>+62 889 9690 6232</li>
							</ul>
						</li>
						<li>
							<ul class="address-text">
								<li><b>ADDRESS </b></li>
								<li>236 Usman Sadar,Gresik.</li>
							</ul>
						</li>
						<li>
							<ul class="address-text">
								<li><b>E-MAIL </b></li>
								<li><a href="mailto:rozacko.rz@gmail.com"> rozacko.rz@gmail.com</a></li>
							</ul>
						</li>
						<li>
							<ul class="address-text">
								<li><b>WEBSITE </b></li>
								<li><a href="http://rozacko.com">www.rozacko.com</a></li>
							</ul>
						</li>
...
<!-- //for bootstrap working -->
	<script src="{{ asset('/web_person/js/bootstrap.js')}}"></script>
